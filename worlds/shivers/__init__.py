from .Items import item_table, ShiversEvent, ShiversItem
from .Rules import set_rules
from BaseClasses import Event, Item, ItemClassification, Tutorial, Region, Location
...
class ShiversWorld(World):
    ...
    def create_event_location(self, region_name: str, event_name: str) -> None:
        ...
        loc.place_event(ShiversEvent(event_name, ItemClassification.progression, self.player))
        loc.locked = True
    ...
    def create_regions(self) -> None:
        ...
        self.add_event_to_location("Puzzle Solved Clock Chains", "Set Clock Chains")
        self.add_event_to_location("Puzzle Solved Bedroom Elevator", "Use Bedroom Elevator")
        self.add_event_to_location("Flashback Memory Obtained Professor Windlenot's Diary", "Read Professor Windlenot's Diary")
